...
def recommend(user_id):
	# _id,desc,title
	products = pd.read_csv('/home/bdnha/vsCode/e-commerce-api-feature-test/data/products.csv', error_bad_lines=False, encoding="latin-1",dtype=object)
	...
	users = pd.read_csv('/home/bdnha/vsCode/e-commerce-api-feature-test/data/users.csv', error_bad_lines=False, encoding="latin-1")
	users.columns = ["userID","email","password","name","ff"]
	# adduserid = []
	...
	ratings = pd.read_csv('/home/bdnha/vsCode/e-commerce-api-feature-test/data/ratings.csv', error_bad_lines=False, encoding="latin-1",dtype=object)
...
recommend("63b58082ca8804b0c0b30092")
