...
def recommend(user_id):
    # _id,desc,title
    products = pd.read_csv('/home/bdnha/vsCode/e-commerce-api-feature-test/data/products.csv', error_bad_lines=False,
                           encoding="latin-1", dtype=object)
    ...
    users = pd.read_csv('/home/bdnha/vsCode/e-commerce-api-feature-test/data/users.csv', error_bad_lines=False,
                        encoding="latin-1")
    ...
    ratings = pd.read_csv('/home/bdnha/vsCode/e-commerce-api-feature-test/data/ratings.csv', error_bad_lines=False,
                          encoding="latin-1", dtype=object)
